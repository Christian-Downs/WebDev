        ...
        <div class="w3-bar w3-light-grey topnav w3-top">
            ...
            function loginCheck()
            {
                ...
                if (isset($_SESSION['user'])) {
                    ...
                    echo "<a href='createBusiness.php' class='w3-bar-item w3-button w3-right " . ((basename($_SERVER['PHP_SELF']) == "createBusiness.php") ? 'w3-green' : '') . "' style='height:33px'><i class='fa fa-dollar'></i></a>";
                    echo "<a href='yourBusinesses.php' class='w3-bar-item w3-button w3-right " . ((basename($_SERVER['PHP_SELF']) == "yourBusinesses.php") ? 'w3-green' : '') . "' style='height:33px'><i class='fa fa-suitcase'></i></a>";
